...
const CartPage = () => {
    const {cart, setView, cartTotal, removeFromCart, updateQuantity} = useContext(AppContext);
                    ...
                    <div className="space-y-4 mb-6">
                        {cart.map(item => (
                            <div key={item._id} className="flex items-center gap-2 sm:gap-4 border-b pb-4">
                                <div className="text-2xl sm:text-4xl"><img className='w-34 h-34 object-cover rounded-md' src={item.image} alt="" /></div>
